...
See [JupyterLabMagics.md](JupyterLabMagics.md) for a complete reference of every magic with usage examples.

## Full user guide

See [JupyterLabGuide.md](JupyterLabGuide.md) for detailed documentation of every magic, the Python API, sidebar panel setup, and environment-specific notes.

## Examples

See [JupyterLabExamples.md](JupyterLabExamples.md) for real-life scenarios across different environments.
